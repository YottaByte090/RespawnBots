...
#define PLUGIN_AUTHOR "rrrfffrrr and Yottabyte090"
#define PLUGIN_URL ""
...
new Handle:cvarMessage = INVALID_HANDLE;
...
new String:msg[128] = "남은 Insurgent : %i";
...
public void OnPluginStart()
{
	...
	cvarMessage = CreateConVar("sm_botrespawn_message", "남은 Insurgent : %i", "The message that displays on the screen", FCVAR_NOTIFY);
	...
	HookConVarChange(cvarMessage, messageUpdate);
...
public messageUpdate(Handle:cvar, const String:oldvalue[], const String:newvalue[]){
...
public Action:FDisplayPoint(Handle:timer) {
	...
	if (i_display == 1) {
		Format(hint, MAXHINTSIZE, msg, ((i_remainPoint > 0) ? i_remainPoint : 0) + GetFakeClientCount());
	}
